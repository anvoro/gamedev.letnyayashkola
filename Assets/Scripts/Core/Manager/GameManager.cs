...
namespace Core.Manager
{
	...
	{
		[SerializeField] private float _nextLaunchCooldown = 5f;

		private Coroutine _cooldownCoroutine;
		private bool _cooldownEndBroadcasted;
		...
		{
			EventBus<NextLaunchCooldownStartEvent>.Broadcast(
				new NextLaunchCooldownStartEvent(this._nextLaunchCooldown));
